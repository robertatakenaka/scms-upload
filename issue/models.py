...
class Issue(CommonControlField, IssuePublicationDate):
    ...
    @classmethod
    def create(cls, user, journal, volume, supplement, number, publication_year, is_continuous_publishing_model=None, total_documents=None):
        try:
            obj = cls()
            obj.journal = journal
            obj.volume = volume
    ...
    @classmethod
    def get_or_create(cls, journal, volume, supplement, number, publication_year, user, is_continuous_publishing_model=None, total_documents=None):
        try:
            obj = cls.get(
                journal=journal,
                volume=volume,
            ...
            return cls.create(
                ...
                is_continuous_publishing_model, total_documents,
            )
