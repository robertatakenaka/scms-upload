...
class MigratedIssue(MigratedData):
    ...
    htmls = models.ManyToManyField(SciELOHTMLFile, related_name='html_files')
    xmls = models.ManyToManyField(XMLFile, related_name='xml_files')
    pdfs = models.ManyToManyField(FileWithLang, related_name='rendition_files')
    ...
    class Meta:
        indexes = [
            ...
            models.Index(fields=['htmls']),
            models.Index(fields=['xmls']),
            models.Index(fields=['pdfs']),
        ]
...
class MigratedDocument(MigratedData):
    ...
    xml_body_files = models.ManyToManyField('BodyAndBackXMLFile')
    files_status = models.CharField(
        _('Status'), max_length=20,
        choices=choices.MIGRATION_STATUS,
        default=choices.MS_TO_MIGRATE,
