...
DEFAULT_FROM_EMAIL = env(
    ...
    default="SciELO Upload <upload@scielo.xxx>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    ...
    default="[SciELO Upload]",
)
# https://docs.djangoproject.com/en/dev/ref/settings/#std-setting-EMAIL_HOST
EMAIL_HOST = env.str("DJANGO_EMAIL_HOST", default="mailrelay.scielo.xxx")

# https://docs.djangoproject.com/en/dev/ref/settings/#email-port
EMAIL_PORT = env.int("DJANGO_EMAIL_PORT", default=25)

# https://docs.djangoproject.com/en/dev/ref/settings/#email-host-user
EMAIL_HOST_USER = env.str("DJANGO_EMAIL_HOST_USER", default="upload@scielo.xxx")
