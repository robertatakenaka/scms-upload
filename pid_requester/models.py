...
class PidRequesterXML(CommonControlField):
    ...
    def _create(
        ...
        try:
            ...
            LOGGER.exception(e)
            raise exceptions.PidRequesterXMLCreateError(
                _("PidRequesterXML create error: {} {} {}").format(
                    type(e),
                    e,
                    xml_adapter,
                )
    ...
    def _update(
        ...
        try:
            ...
            LOGGER.exception(e)
            raise exceptions.PidRequesterXMLUpdateError(
                _("PidRequesterXML Update data error: {} {} {}").format(
                    type(e),
                    e,
                    xml_adapter,
                )
