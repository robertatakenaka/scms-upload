...
@patch("pid_requester.models.PidRequesterXML.xml_uri", new_callable=mock.PropertyMock)
...
@patch("pid_requester.models.PidRequesterXML.add_version")
...
@patch(
    "pid_requester.xml_sps_adapter.PidRequesterXMLAdapter.article_titles_texts",
    new_callable=mock.PropertyMock(return_value="data-z_article_titles_texts"),
)
@patch(
    "pid_requester.xml_sps_adapter.PidRequesterXMLAdapter.surnames",
    new_callable=mock.PropertyMock(return_value="data-z_surnames"),
)
@patch(
    "pid_requester.xml_sps_adapter.PidRequesterXMLAdapter.collab",
    new_callable=mock.PropertyMock(return_value="data-z_collab"),
)
@patch(
    "pid_requester.xml_sps_adapter.PidRequesterXMLAdapter.partial_body",
    new_callable=mock.PropertyMock(return_value="data-z_partial_body"),
)
@patch(
    "pid_requester.xml_sps_adapter.PidRequesterXMLAdapter.links",
...
@patch("pid_requester.models.utcnow", return_value="2020-02-02")
@patch("pid_requester.models.PidRequesterXML.add_version")
...
@patch("pid_requester.models.utcnow", side_effect=["2020-02-02", "2020-02-03"])
@patch("pid_requester.models.PidRequesterXML.add_version")
...
class PidRequesterXMLCreateTest(TestCase):
    def test_create(
        ...
        xml_adapter = _get_xml_adapter()
        pkg_name = "filename"
        registered = models.PidRequesterXML._create(
...
@patch("pid_requester.models.utcnow", return_value="2020-02-03")
@patch("pid_requester.models.PidRequesterXML.add_version")
@patch("pid_requester.models.PidRequesterXML._add_data")
@patch("pid_requester.models.PidRequesterXML.save")
