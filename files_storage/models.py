...
class MinioConfiguration(CommonControlField):
    ...
    name = models.TextField(
        _('Name'), null=True, blank=False)
    host = models.TextField(
        _('Host'), null=True, blank=True)
    bucket_root = models.TextField(
        _('Bucket root'), null=True, blank=True)
    bucket_app_subdir = models.TextField(
        _('Bucket app subdir'), null=True, blank=True)
    access_key = models.TextField(
        _('Access key'), null=True, blank=True)
    secret_key = models.TextField(
        _('Secret key'), null=True, blank=True)
