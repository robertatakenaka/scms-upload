...
class Package(CommonControlField, ClusterableModel):
    pkgzip = models.ForeignKey(PackageZip, null=True, blank=True, on_delete=models.SET_NULL)
    file = models.FileField(
        _("Package File"),
        upload_to=upload_package_directory_path,
        null=False,
    ...
    def data(self):
        return dict(
            file=self.pkgzip and self.pkgzip.name,
            pkg_name=self.package_name,
            zip_name=self.pkgzip and self.pkgzip.name,
            status=self.status,
