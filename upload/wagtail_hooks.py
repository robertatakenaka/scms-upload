...
class PackageAdmin(ModelAdmin):
    ...
    menu_label = _("Uploaded packages")
    menu_icon = "folder"
    menu_order = 200
    add_to_settings_menu = False
    exclude_from_explorer = False
...
class ReadyToPreviewPackageAdmin(ModelAdmin):
    model = ReadyToPreviewPackage
    ...
    menu_icon = "folder"
    menu_order = 200
    edit_view_class = ReadyToPreviewPackageEditView
    inspect_view_enabled = True
    inspect_view_class = PackageAdminInspectView
    inspect_template_name = "modeladmin/upload/package/inspect.html"
    add_to_settings_menu = False
